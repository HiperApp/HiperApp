  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        // Usa rem (não px) para que este tamanho também aumente quando o
        // usuário ativa fonte "grande" ou "muito grande" na acessibilidade
        // — antes ficava travado em 17px e não crescia.
        base: ["1.0625rem", { lineHeight: "1.6rem" }], // 17px no tamanho normal
      },
      borderRadius: {
        card: "20px",
        button: "16px",
