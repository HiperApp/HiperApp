  ...
  return (
    <div className="mb-4">
      ...
      <p className="text-xs text-gray-400 mt-2">
        As cores representam apenas um recurso visual do HiperApp para facilitar a identificação
        da intensidade da alteração da pressão arterial ao longo do tempo. Elas NÃO correspondem a
        categorias diagnósticas da Diretriz Brasileira de Hipertensão Arterial 2025.
      </p>
    </div>
  );
}
  ...
  return (
    <>
      ...
      <Card className="mb-4">
        ...
        <p className="text-xs text-gray-400 mt-2">
          A linha em 120 mmHg marca a referência (120/80); abaixo de{" "}
          {FAIXAS_PRESSAO.baixa.pasMax + 1} mmHg é considerado hipotensão. Cada ponto é colorido
          pela aferição completa (sistólica e diastólica juntas), então a cor pode refletir a
          diastólica mesmo com a sistólica próxima da referência. Avaliação educativa, não
      ...
      <Card className="mb-4">
        ...
        <p className="text-xs text-gray-400 mt-2">
          A linha em 80 mmHg marca a referência (120/80); abaixo de{" "}
          {FAIXAS_PRESSAO.baixa.padMax + 1} mmHg é considerado hipotensão. Cada ponto é colorido
          pela aferição completa (sistólica e diastólica juntas), então a cor pode refletir a
          sistólica mesmo com a diastólica próxima da referência. Avaliação educativa, não
          substitui consulta médica.
        </p>
      </Card>
