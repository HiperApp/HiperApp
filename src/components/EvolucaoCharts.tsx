    ...
    <>
      ...
      <Card className="mb-4">
        ...
        <div className="h-48 -ml-4">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={dados} margin={{ top: 5, right: 10, left: margemEsquerda, bottom: 0 }}>
              ...
              <ReferenceArea
                y1={FAIXAS_PRESSAO.hipotensao.pasMax + 1}
                y2={FAIXAS_PRESSAO.normal.pasMax}
                fill="#2E9E5B"
                fillOpacity={0.08}
              />
              <ReferenceLine
                y={FAIXAS_PRESSAO.preHipertensao.pasMin}
                stroke="#E0A500"
                strokeDasharray="4 4"
                label={{
                  value: "Elevada ↑",
              ...
              />
              <ReferenceLine
                y={FAIXAS_PRESSAO.hipotensao.pasMax}
                stroke="#2563EB"
                strokeDasharray="4 4"
                label={{
                  value: "Baixa ↓",
        ...
        <p className="text-xs text-gray-400 mt-2">
          Acima de {FAIXAS_PRESSAO.preHipertensao.pasMin} mmHg já é considerado elevado; abaixo de{" "}
          {FAIXAS_PRESSAO.hipotensao.pasMax} mmHg é considerado baixo. A faixa verde mostra o
      ...
      <Card className="mb-4">
        ...
        <div className="h-48 -ml-4">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={dados} margin={{ top: 5, right: 10, left: margemEsquerda, bottom: 0 }}>
              ...
              <ReferenceArea
                y1={FAIXAS_PRESSAO.hipotensao.padMax + 1}
                y2={FAIXAS_PRESSAO.normal.padMax}
                fill="#2E9E5B"
                fillOpacity={0.08}
              />
              <ReferenceLine
                y={FAIXAS_PRESSAO.preHipertensao.padMin}
                stroke="#E0A500"
                strokeDasharray="4 4"
                label={{
                  value: "Elevada ↑",
              ...
              />
              <ReferenceLine
                y={FAIXAS_PRESSAO.hipotensao.padMax}
                stroke="#2563EB"
                strokeDasharray="4 4"
                label={{
                  value: "Baixa ↓",
        ...
        <p className="text-xs text-gray-400 mt-2">
          Acima de {FAIXAS_PRESSAO.preHipertensao.padMin} mmHg já é considerado elevado; abaixo de{" "}
          {FAIXAS_PRESSAO.hipotensao.padMax} mmHg é considerado baixo. A faixa verde mostra o
          intervalo adequado. Como cada ponto é colorido pela aferição completa (sistólica e
