...
import { classificarPressao, MENSAGEM_ALERTA_EMERGENCIA, MENSAGEM_ALERTA_HIPOTENSAO } from "@/lib/classification";
    ...
    <div className="px-6 pt-14 pb-10">
      ...
      <form onSubmit={handleSalvar} className="flex flex-col gap-5">
        ...
        {previa?.alertaHipotensao && (
          <div role="alert" className="bg-amber-50 border-2 border-amber-400 rounded-card p-4">
