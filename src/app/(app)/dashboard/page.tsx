...
import { DICAS_IMPORTANTES, classificarPressao } from "@/lib/classification";
...
export default async function DashboardPage() {
  ...
  return (
    <div className="px-6 pt-14 pb-6">
      ...
      {avaliacao && <AvaliacaoCard avaliacao={avaliacao} />}

      {(profile?.diagnostico_hipertensao === null || profile?.diagnostico_hipertensao === undefined) && (
        <Link
        ...
        >
          <span className="font-medium text-gray-700 text-sm">
            🩺 Você possui diagnóstico de hipertensão? Responda para melhorar suas orientações
          </span>
