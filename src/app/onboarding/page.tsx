...
const SLIDES = [
  ...
  {
    emoji: "➕",
    titulo: "Adicionar medições",
    texto: "Registre seus valores de pressão diariamente.",
  },
  {
    emoji: "📈",
  ...
  },
  {
    ...
    texto: "Tenha suas informações organizadas para acompanhar junto ao profissional de saúde.",
  },
];
