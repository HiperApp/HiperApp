 ...
 *
 * Faixas atualizadas conforme definição do próprio HiperApp:
 *
 *   🔵 Baixa (hipotensão):            PAS < 90  e/ou PAD < 60
 *   🟢 Adequada:                      PAS < 130 e    PAD < 85
 *   🟡 Levemente alterada/elevada:    PAS 130–139 e/ou PAD 85–89
...
export interface ClassificacaoResultado {
  ...
  rotuloVisual: "Adequada" | "Levemente alterada" | "Alta" | "Baixa" | "Muito alta";
  simbolo: "" | "↑" | "↓" | "⚠";
...
export const FAIXAS_PRESSAO = {
  ...
  adequada: { pasMax: 129, padMax: 84 },
  levementeAlterada: { pasMin: 130, pasMax: 139, padMin: 85, padMax: 89 },
...
export function classificarPressao(
  ...
  // 🟡 Levemente alterada/elevada — amarelo: PAS 130–139 e/ou PAD 85–89
  if (
  ...
  // 🟢 Adequada — verde: PAS < 130 e PAD < 85
  return {
    chave: "adequada",
